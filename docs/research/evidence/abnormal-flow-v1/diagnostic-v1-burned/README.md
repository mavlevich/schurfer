...
This directory contains the results of an inconclusive diagnostic run executed on the prospective evaluation window [2026-08-30T00:00:00Z, 2026-09-18T11:58:00Z).
...
| :------ | :------------------- | :------------------- | :---------------------------------------------------------- | :---------------------------------- | :------------ | :--------------- |
| 1       | 2026-09-22T20:55:09Z | `unknown/unverified` | `uv run python /tmp/run_formal.py` (unknown/unrecoverable)  | Assembly `TypeError`                | No            | No               |
...
- Diagnostic Report (`formal_run_report.json`): Preserved exactly as emitted. SHA-256 `c966b5d7f1ab4934416f42f6ee0699bbd118401239fe36c805f82f66d0752f15`

## Numerical Report (Diagnostic only)

The numerical report (`formal_run_report.json`) is preserved. Key metrics:
