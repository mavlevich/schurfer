...
- Total settlements: 81,268 (Binance 42,730; Bybit 38,538).
- Raw settlement rows are stored as `funding_settlements.json.gz` (81,268 rows,
  SHA-256 `b4fb338622152886ae5a51a1f16af7352dd6289b31d368a938b2c9b4232926d4`).
...
- Binance P95 = ~6.03 bps / 720m; P99 = ~13.31 bps / 720m.
- Bybit P95 = ~5.74 bps / 720m; P99 = ~15.53 bps / 720m.
