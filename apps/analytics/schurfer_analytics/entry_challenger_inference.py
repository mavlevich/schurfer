"""Formal inference for the pre-registered entry-confirmation family."""
...
@dataclass(frozen=True)
class EntryChallengerInference:
...
def _observations(
    ...
    getter: Callable[[InferenceEpisode], float | None],
...
def build_entry_challenger_inference(
    ...
    *,
    ...
    return EntryChallengerInference(
